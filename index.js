...
async function zynxzoStart() {
    ...
    if (usePairingCode && !zynxzo.authState.creds.registered) {
        ...
        say("Create By AndraZyy Ganteng", {
            font: 'console',
            align: 'center',
            gradient: [randomcolor, randomcolor]
        });
    ...
    const cFimage = ["https://pomf2.lain.la/f/q04d9l5a.jpg"]
    ...
    zynxzo.ev.on('connection.update', async (update) => {
        ...
        try {
            ...
            zynxzo.sendMessage('6288287150630@s.whatsapp.net', {
    image: {
        url: `${gambarbanyak}`
        },
    caption: `𝐒𝐯 𝐀𝐧𝐝𝐫𝐚𝐙𝐲𝐲 𝐀𝐠𝐥𝐞𝐫 𝐅𝐨𝐫𝐠𝐞𝐫`
        })
                /*                say("ModsV3\n", {
                                    font: 'block',
                                    align: 'center',
                ...
                await console.log(color("\nCreate By AndraZyy Dev\nYOUTUBE : AndraZyy\nℂ𝕠𝕕𝕖 ℙ𝕒𝕚𝕣𝕚𝕟𝕘 ℕ𝕪𝕒 𝔻𝕚 𝔸𝕥𝕒𝕤\n", `${randomcolor}`))
